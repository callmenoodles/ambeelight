...
input_ip.grid(row=1, column=0, sticky="ew")
...
slider_brightness = CTkSlider(frame, progress_color=primary_color, button_color=primary_color, hover=False, from_=1, to=100)
slider_brightness.set(40)
slider_brightness.grid(row=3, column=0, sticky="ew")

lbl_interval = CTkLabel(frame, text="Interval", text_color="white", fg_color="transparent")
lbl_interval.grid(row=4, column=0, sticky="w")

slider_interval = CTkSlider(frame, progress_color=primary_color, button_color=primary_color, hover=False, from_=100, to=1000)
slider_interval.set(200)
slider_interval.grid(row=5, column=0, sticky="ew")
...
slider_transition = CTkSlider(frame, progress_color=primary_color, button_color=primary_color, hover=False, from_=100, to=1000)
slider_transition.set(200)
slider_transition.grid(row=7, column=0, sticky="ew")

btn_power = CTkButton(app, text="Power", hover=False, corner_radius=0, fg_color=primary_color, height=35, command=toggle, cursor="hand2")
